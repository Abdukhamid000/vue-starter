<template>
  <div class="p-8 pt-14 max-xl:p-5 max-xl:pt-10 cursor-pointer card">
    <div>
      ...
      ></div>
      <svg
        class="absolute right-7 top-7 max-xl:top-6 max-xl:right-6 max-xl:w-6 max-xl:h-6"
        width="32.000000"
        height="32.000000"
        viewBox="0 0 32 32"
        fill="none"
      ...
      >
        ...
        <g clip-path="url(#clip3_337)">
          <path
            id="Vector"
            d="M21 19.3335C18.3333 16.6667 13.6667 16.6667 11 19.3335"
            stroke="#2E05FF"
          ...
          <path
            id="Vector"
            d="M24.6667 15.3333C19.6432 10.8889 12.6667 10.8889 7.33337 15.3333"
            stroke="#2E05FF"
            stroke-opacity="1.000000"
            stroke-width="1.500000"
            stroke-linejoin="round"
          ...
          <path
            id="Vector"
            d="M29.3333 11.3333C20.9122 4.22217 11.0877 4.22217 2.66663 11.3333"
            stroke="#2E05FF"
            stroke-opacity="1.000000"
            stroke-width="1.500000"
            stroke-linejoin="round"
    ...
    >
      Мы арендуем мощные сервера по всему СНГ для того, чтобы ни один клиент не
      столкнулсяс подтормаживанием при
    </p>
  </div>
</template>
